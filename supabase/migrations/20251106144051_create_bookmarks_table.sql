-- =====================================================
-- 마이그레이션: bookmarks 테이블 생성
-- 작성일: 2025-11-06
-- 설명: My Trip 프로젝트의 북마크 기능을 위한 데이터베이스 테이블
...
--   - supabase/migrations/my_tour_schema.sql: 기존 스키마 참고
--   - TODO.md: 개발 체크리스트
-- =====================================================
...
comment on column public.bookmarks.id is '북마크 고유 ID (UUID)';
comment on column public.bookmarks.user_id is 'users 테이블의 사용자 ID (외래키)';
